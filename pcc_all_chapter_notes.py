...
contents = "I love reworking programs.\n"          # Append a list
...
def count_words(path):
    ...
    try:                                            # contents holds alice.txt below as one long stri
        ...
        words = contents.split()                   # sep by whitespace as default (words), rtn a List
        num_words = len(words)    
...
# OR Revised Attempt / 10.7 Addition Calculator
...
#         num2 = input(f"Enter the second number: (or 'q' to quit)")
#         if num2.lower() == 'q':
#             break
